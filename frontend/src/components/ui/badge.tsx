  ...
  'inline-flex items-center rounded-full border px-2 py-0.5 text-xs font-semibold transition-colors',
  {
    variants: {
      variant: {
        ...
        info: 'border-transparent bg-matcha-100 text-matcha-700 dark:bg-matcha-500/20 dark:text-matcha-300',
        muted: 'border-transparent bg-slate-100 text-slate-600 dark:bg-slate-400/15 dark:text-slate-300',
      },
    },
